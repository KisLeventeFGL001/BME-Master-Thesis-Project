...
[LAMBDA,tri_LAMBDA,lambda_to_average,tri_to_average]=baryc_weights3D(DT_geometry,DT_mes_0);
...
[X_interp,Y_interp,Z_interp] = baryc3D_interpolation(LAMBDA,tri_LAMBDA,DT_mes,lambda_to_average,tri_to_average);
